        ...
        <Row>
          <Col md={8}>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <h2>Ordre de produits</h2>
                {order.orderItems.length === 0 ? (
                  <Message>Votre ordre est vide</Message>
                ) : (
                  <ListGroup variant="flush">
