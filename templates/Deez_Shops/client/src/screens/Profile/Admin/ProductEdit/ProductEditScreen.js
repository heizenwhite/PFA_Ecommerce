  ...
  return (
    <>
      <Container className="mb-5">
        ...
        {successUpdate && (
          <DropNotif
            heading="Mettre à jour produit"
            text="Mis à jour avec succes"
            resetData={() => {
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId="selection">
              ...
              >
                ...
                <option value="Men">Vêtement Homme</option>
                <option value="Women">Vêtement Femme</option>
